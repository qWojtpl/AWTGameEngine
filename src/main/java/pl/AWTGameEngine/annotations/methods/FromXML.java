 ...
 * is an name of XML field with first big letter. It can have only one argument.
 * <pre>
 * {@code
 *      @FromXML
 ...
 * {@link pl.AWTGameEngine.engine.deserializers.XMLDeserializer#addParameterTypeHandler(ParameterTypeHandler)}
 */
