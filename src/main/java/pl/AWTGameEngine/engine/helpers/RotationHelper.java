...
public class RotationHelper {
    ...
    public static double[] quaternionToEulerXYZ(double x, double y, double z, double w) {
        ...
        final double m00 = 1 - 2 * (y * y + z * z);
        final double m01 = 2 * (x * y - z * w);

        final double m10 = 2 * (x * y + z * w);
        final double m11 = 1 - 2 * (x * x + z * z);

        final double m20 = 2 * (x * z - y * w);
        final double m21 = 2 * (y * z + x * w);
        final double m22 = 1 - 2 * (x * x + y * y);
    ...
    public static Vector3 multiplyWithQuaternion(Vector3 vector3, Vector4 q) {
